...
const makeSocket = (config) => {
  ...
  if (ws.readyState !== ws.OPEN) {
    console.log('Connection Closed. Ignore this message.');
    return;
  }
  ...
  try {
    await new Promise((resolve, reject) => {
      const timeoutId = setTimeout(() => {
        reject(new Error('Timeout while sending raw message'));
      }, connectTimeoutMs);
      sendPromise.call(ws, bytes)
        .then(() => {
    ...
    console.log('Connection closed, issue resolved.');
  }
};
